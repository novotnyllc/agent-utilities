...
def validate_manifest_data(data: Any) -> list[ValidationIssue]:
    ...
    expected_print_part_paths: list[str] = []
    expected_print_parts_wellformed = False
...
def _validate_printable_parts(
    ...
    expected_print_part_paths: list[str],
    expected_print_parts_wellformed: bool,
    source_map: dict[str, dict[str, Any]],
) -> None:
    ...
    if expected_print_parts_wellformed and set(part_paths) != set(expected_print_part_paths):
