...
_BOX_SPECS = (
    {
        "path": "References/PD Trigger Envelope",
        "body_name": "Positive Control PD Trigger Envelope",
        "size_parameters": ["src_pd_board_length", "src_pd_board_width", "src_pd_board_height"],
        "origin_mm": [0.0, 0.0, 0.0],
    },
    {
        "path": "References/EKYLIN Converter Envelope",
        "body_name": "Positive Control EKYLIN Envelope",
        "size_parameters": ["src_ekylin_length", "src_ekylin_width", "src_ekylin_height"],
        "origin_mm": [120.0, 0.0, 0.0],
    },
    {
        "path": "References/USB-C Insertion Keep-Out",
        "body_name": "Positive Control USB-C Insertion Keep-Out",
        "size_mm": [20.0, 20.0, 5.0],
        "origin_mm": [0.0, 0.0, 0.0],
    },
    {
        "path": "References/EKYLIN Wire Bend Keep-Out",
        "body_name": "Positive Control EKYLIN Wire Bend Keep-Out",
        "size_mm": [20.0, 20.0, 5.0],
        "origin_mm": [120.0, 0.0, 0.0],
    },
    {
        "path": "Product/Base",
        "body_name": "Positive Control Base",
        "size_mm": [100.0, 60.0],
    ...
    {
        "path": "Product/Lid",
        "body_name": "Positive Control Lid",
        "size_parameters": ["src_pd_board_length", "src_pd_board_width", "fab_wall_thickness"],
        "origin_mm": [0.0, 0.0, 10.0],
    },
    {
        "path": "Validation/PD Fit Coupon",
        "body_name": "Positive Control PD Fit Coupon",
        "size_mm": [10.0, 10.0],
        "height_parameter": "fab_wall_thickness",
