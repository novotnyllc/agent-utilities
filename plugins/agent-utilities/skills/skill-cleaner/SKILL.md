...
- `Unused candidates`: no recent user mention or actual `SKILL.md` read in recent agent logs.
...
- Prefer deleting repo-local or aggregate-root duplicates when Codex built-ins cover them.
