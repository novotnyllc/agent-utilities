---
name: browser-use
description: "Existing Chrome automation: native browser tool first, mcporter fallback."
---
...
1. If a native browser-control tool is callable in the current session, use it first. In Codex, this is usually the `Chrome` or `Chrome [Internal]` plugin.
